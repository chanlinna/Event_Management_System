    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center p-6 border-b border-slate-500">
        <div className="flex-shrink-0 flex items-center">
          <div className="text-white text-3xl font-normal font-['Righteous']">EventNA</div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-slate-500">
        <button className="w-full flex items-center justify-center px-4 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all">
